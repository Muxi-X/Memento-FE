  ...
  return (
    <SafeAreaProvider style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.paragraph}>
          2. 用户应保证所提交信息的真实性、合法性和有效性。
        </Text>
        <Text style={styles.paragraph}>
          3. 用户应妥善保管账号及登录凭证，因账号使用产生的行为后果由用户自行承担。
        </Text>
        <Text style={styles.paragraph}>
          4. 如发现账号存在异常使用，用户应及时通知我们。
        </Text>
        ...
        <Text style={styles.paragraph}>
          1. 用户对其上传或创建的内容依法享有相应权利。
        </Text>
        <Text style={styles.paragraph}>
          2. 用户保证其上传内容不侵犯任何第三方的合法权益。
        </Text>
        ...
        <Text style={styles.paragraph}>
          2. 侵犯他人隐私权、肖像权、著作权等合法权益的内容
        </Text>
        <Text style={styles.paragraph}>
          3. 含有恶意、歧视、暴力、骚扰、误导性信息的内容
        </Text>
        <Text style={styles.paragraph}>
          4. 用于商业推广、刷量或其他不当用途的内容
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          1. 本产品可能根据运营情况对功能进行更新、调整或中断。
        </Text>
        <Text style={styles.paragraph}>
          2. 如涉及重大变更，将通过合理方式进行提示。
        </Text>
        <Text style={styles.paragraph}>
